...
#product categoryList
        ...
        self.green=["g_nonpolish","g_polish"]
       ...
       #Image3
        ...
        #Label Title
        lbl_title=Label(self.root,text="KALIKA IMITATION JEWELLERY,BARSHI",font=("times new roman",35,"bold"),bg="white",fg="red")
...
#ProductName
        ...
        self.lbl_productName.grid(row=0,column=0,stick=W,padx=5,pady=2)
    
        self.combo_productName=ttk.Combobox(Product_Frame,value=self.catlist,font=('arial',12,'bold'),width=24,state='readonly')
        self.combo_productName.grid(row=0,column=1,padx=5,pady=2)
...
#Button Frame
    ...
    def Categories(self,event=""):
        self.combo_productName.config(value=self.catlist)
        self.combo_productName.current(0)
    ...
    def AddItem(self):
        ...
        if self.combo_productName.get()=="":
           ...
           self.textarea.insert(END,f"\n {self.Counter} \t {self.combo_productName.get()} \t\t{self.qty.get()} \t{self.price.get()} \t\t{self.m}")
    ...
    def gen_bill(self):
        if self.combo_productName.get()=="":
            ...
            text=self.textarea.get(8.0,(10.0+float(len(self.l))))
            messagebox.showinfo("Items",text)
